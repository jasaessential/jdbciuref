...
import { ArrowRight, Search, X, ChevronRight, ChevronDown } from "lucide-react";
...
export default function Home() {
  ...
  const categoryDisplayInfo = {
      stationary: { title: "Featured Stationary", href: "/stationary", className: "bg-gradient-to-br from-blue-500 to-blue-700" },
      books: { title: "Latest Books", href: "/books", className: "bg-gradient-to-br from-green-500 to-green-700" },
      electronics: { title: "Top Electronic Kits", href: "/electronics", className: "bg-gradient-to-br from-orange-500 to-orange-700" },
  }
    ...
    return (
      <Card className={cn("overflow-hidden", catInfo.className)}>
        <CardHeader className="text-center">
            <CardTitle className="font-headline text-2xl font-bold tracking-tight sm:text-3xl text-white">{catInfo.title}</CardTitle>
        </CardHeader>
        <CardContent>
             <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
